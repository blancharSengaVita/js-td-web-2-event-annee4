...
let imageDataHover = image.dataset.hover;
//copie de l'objet != refernce


image.addEventListener('click', ()=>{
 // [image.src, image.dataset.hover] = [image.dataset.hover, image.src];
 //  [imageSrc, imageDataHover] = [imageDataHover, imageSrc];
//pq les chemins sont differents ?
 console.log(change);
 console.log(change2);
});
